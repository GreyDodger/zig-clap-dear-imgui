...
CIMGUI_API bool cimgui::ImGui_Shortcut(ImGuiKeyChord key_chord)
{
    return ImGui::Shortcut(key_chord);
}

CIMGUI_API bool cimgui::ImGui_ShortcutEx(ImGuiKeyChord key_chord, ImGuiID owner_id, ImGuiInputFlags flags)
{
