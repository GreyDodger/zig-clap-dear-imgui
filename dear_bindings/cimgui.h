...
CIMGUI_API bool ImGui_Shortcut(ImGuiKeyChord key_chord);                                                                 // Implied owner_id = 0, flags = 0
CIMGUI_API bool ImGui_ShortcutEx(ImGuiKeyChord key_chord, ImGuiID owner_id /* = 0 */, ImGuiInputFlags flags /* = 0 */);
